...
CFactoryDlg::CFactoryDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CFactoryDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CFactoryDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CFactoryDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CFactoryDlg::OnQueryDragIcon()
{
